...
?>
  ...
  <div class="container_24"> 
   <div id="footer" class="grid_24 d_bar"> 
    <p><?php if (isset($total)) echo round($total, 3)." seconds |"; ?> &copy; 2011-2012 <a href="http://wesunsolve.net">We Sun Solve!</a> | Hosting by <a href="http://www.espix.org">Espix Network</a> | <a href="/disclaimer">disclaimer</a> | <a href="/contact">contact</a></p> 
   </div><!-- d_footer --> 
  </div><!-- container_24 --> 
