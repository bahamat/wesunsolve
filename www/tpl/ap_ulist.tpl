...
?>
  ...
  <p><?php echo $title; ?></p>
  <p><form action="/ap_ulist" method="GET">
     Username: <input type="text" name="filter" value=""/><br/>
     Email: <input type="text" name="efilter" value=""/><br/>
     <input type="submit" name="f" value="filter"/></form></p>
  <div class="ctable">
