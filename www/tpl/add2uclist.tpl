...
?>
    <div id="d_content">
     <h2 class="grid_10 push_1 alpha omega">Add patches to user list</h2>
     <div class="clear"></div>
  ...
  <form method="post" action="/add2uclist/form/1/uid/<?php echo $ulist->id; ?>">
  <div class="ctable">
  ...
  <p>Theses patches will be added to list <?php echo $ulist; ?></p>
  <table class="ctable">
