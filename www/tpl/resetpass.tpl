...
?>  
    <div id="d_content">
     <h2 class="grid_10 push_1 alpha omega">Reset your password</h2>
     <div class="clear"></div>
    ...
    <?php if (isset($error)) { ?><p class="warning"><?php if (isset($error) && !empty($error)) echo $error; ?></p><?php } ?>
     <form method="POST" action="/resetpass">
      ...
      <table class="ctable">
        ...
        <tr><td></td><td><input type="submit" class="submit" name="save" value="Reset!"/></td></tr>
      </table>
     </form>
   </div><!-- d_content_box -->
  </div><!-- grid_19 -->
